...
//		}
		...
		public static class Swerve {
			...
			public static class SdsSwerve {
				...
				public static final PIDObject linPID = new PIDObject().withKp(0.0003).withMaxPower(0.5); //todo - calibrate good pid
			...
			public static final double MAX_ANGULAR_ACCELERATION = 5;
			
			
			public static final double angleTicksToWheelToRPM = Swerve.ANG_GEAR_RATIO * General.Motors.SPARKMAX_VELOCITY_UNITS_PER_RPM;
			public static final double linTicksToWheelToRPM = Swerve.LIN_GEAR_RATIO * General.Motors.SPARKMAX_VELOCITY_UNITS_PER_RPM;
			
			public static final double linRPMToMetersPerSecond = WHEEL_CIRC / 60;
			public static final double angleTicksToRadians = Swerve.ANG_GEAR_RATIO * General.Motors.SPARKMAX_TICKS_PER_RADIAN;
			...
			public static final double linTicksToMeters = Swerve.LIN_GEAR_RATIO * General.Motors.SPARKMAX_TICKS_PER_RADIAN * WHEEL_CIRC;
