...
public class ComplexClimb extends GBSubsystem {
	...
	private ComplexClimb() {
		hookMotor = new CANSparkMax(RobotMap.Icarus.ComplexClimb.ComplexClimbMotor.HOOK_MOTOR_PORT, CANSparkMaxLowLevel.MotorType.kBrushless);
		hookMotor.setInverted(RobotMap.Icarus.ComplexClimb.ComplexClimbMotor.HOOK_MOTOR_REVERSED);
		hookEncoder = new SparkEncoder(RobotMap.Icarus.ComplexClimb.ComplexClimbMotor.HOOK_MOTOR_TICKS_PER_METER, hookMotor);
		turningMotor = new CANSparkMax(RobotMap.Icarus.ComplexClimb.ComplexClimbMotor.TURNING_MOTOR_PORT, CANSparkMaxLowLevel.MotorType.kBrushless);
		turningMotor.setInverted(RobotMap.Icarus.ComplexClimb.ComplexClimbMotor.TURNING_MOTOR_REVERSED);
		turningEncoder = new SparkEncoder(RobotMap.Icarus.ComplexClimb.ComplexClimbMotor.TURNING_MOTOR_TICKS_PER_METER, turningMotor);
	}
