...
public class Shooter extends GBSubsystem {
	...
	private Shooter() {
		leader = new CANSparkMax(RobotMap.Icarus.Shooter.Motor.PORT_LEADER, CANSparkMaxLowLevel.MotorType.kBrushless);
		follower = new CANSparkMax(RobotMap.Icarus.Shooter.Motor.PORT_FOLLOWER, CANSparkMaxLowLevel.MotorType.kBrushless);

		leader.setInverted(RobotMap.Icarus.Shooter.Motor.LEADER_INVERTED);
		follower.follow(leader, RobotMap.Icarus.Shooter.Motor.FOLLOWER_INVERTED);
